...
map("n", "<leader>fgf", ":Telescope git_files<CR>", "Find Git Files")
map("n", "<leader>fgb", ":Telescope git_branches<CR>", "Find Git Branches")
map("n", "<leader>fgc", ":Telescope git_commits<CR>", "Find Git Commits")
map("n", "<leader>fgs", ":Telescope git_status<CR>", "Find Git Status")
map("n", "<leader>flr", ":Telescope lsp_references<CR>", "Find LSP References")
map("n", "<leader>fls", ":Telescope lsp_document_symbols<CR>", "Find LSP Symbols")
map("n", "<leader>fn", ":Telescope notify<CR>", "Find Notifications")
map("n", "<leader>ft", ":TodoTelescope<CR>", "Find TODOs")
map("n", "<leader>fi", ":Telescope import<CR>", "Find Imports")
map("n", "<leader>fr", function()
  require("telescope").extensions.refactoring.refactors()
end, "Find Refactors")
map("n", "<leader>fu", ":Telescope undo<CR>", "Find Undos")
map("n", "<leader>fs", function()
  require("auto-session.session-lens").search_session()
end, "Find Active Sessions")
